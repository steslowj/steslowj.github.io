...
date: '2022-09-23'
img: '/src/assets/preview/370_crochet.png'
...
description: 'An infographic showing a map of the world with countries colored by the interest level in crochet, using data from Ravelry.com'
tags:
  - 'Cartography'
  - 'Infographic'
  - 'UW-Mad Geog370'
...
![An infographic showing a map of the world with countries colored by the interest level in crochet, using data from Ravelry.com. The infographic also shows examples of crochet styles.](../../../src/assets/preview/370_crochet.png)
