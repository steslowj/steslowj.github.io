...
date: '2023-07-10'
img: '/src/assets/preview/575_airquality_leaflet.png'
img_alt: 'A website showing the United States with colored points over cities that represent air quality values.'
description: 'Learning JavaScript with the Leaflet JS library while exploring how air quality data changes over time.'
tags:
  - 'UW-Mad Geog575'
  - 'Web'
  - 'Leaflet-JS'
external_url: 'https://steslowj.github.io/geog575_air-quality-leaflet/'
---
...
![A website showing the United States with colored points over cities that represent air quality values.](../../../src/assets/preview/575_airquality_leaflet.png)
