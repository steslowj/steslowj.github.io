/*Custom edits by Jessica Steslow to change icon classes to bootstrap icons*/
...
L.Control.Dialog = L.Control.extend({
  ...
  _initLayout: function() {
    ...
    var grabberIcon = L.DomUtil.create("i", "bi bi-arrows-move");
    ...
    var closeIcon = L.DomUtil.create("i", "bi bi-x-lg");
    ...
    var resizeIcon = L.DomUtil.create("i", "bi bi-arrows-angle-expand");
