...
function updateLegendMon(attribute) {
    ...
    for (var key in circleValues) {
        ...
        document.querySelector("#" + key + "-text-mon").textContent = Math.round(circleValues[key] * 100) / 100 + " AQI";
    }
}
    ...
    var LegendControl = L.Control.extend({
        ...
        onAdd: function () {
            ...
            for (var i = 0; i < circles.length; i++) {
                ...
                //text string
                svg += '<text id="' + circles[i] + '-text-mon" x="65" y="' + textY + '">' +
                    Math.round(monDataStats[circles[i]] * 100) / 100 + " AQI" + "</text>";
            }
