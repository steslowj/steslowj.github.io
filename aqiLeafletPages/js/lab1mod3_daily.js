...
function updateLegendDay(attribute) {
    ...
    for (var key in circleValues) {
        ...
        document.querySelector("#" + key + "-text-day").textContent = Math.round(circleValues[key] * 100) / 100 + " AQI";
    }
}
...
function createLegendDay(attributes) {
    var LegendControl = L.Control.extend({
        ...
        onAdd: function () {
            ...
            container.innerHTML = '<p class="temporalLegend-day">Median AQI on <span class="calDay-day">1/1/2021</span></p>'
            ...
            for (var i = 0; i < circles.length; i++) {
                ...
                //text string
                svg += '<text id="' + circles[i] + '-text-day" x="65" y="' + textY + '">' +
                    Math.round(dayDataStats[circles[i]] * 100) / 100 + " AQI" + "</text>";
            }
